...
Doorkeeper.configure do
  ...
  resource_owner_from_credentials do |routes|
    ...
    owner = params[:owner_type].camelize.constantize.find_for_database_authentication(:email => params[:email]) rescue nil
    if owner && owner.valid_for_authentication? { owner.valid_password?(params[:password]) } && (params[:owner_type]=='admin' || params[:owner_type]=='user')
